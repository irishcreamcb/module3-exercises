...
\begin{enumerate}
    ...
    \begin{minipage}{.76\textwidth}
        ...
        considerably difficult, but technically speaking we do have all the tools we need to solve them. They just need some clever reasoning and intuition. I'll try my best to explain them, \textit{just in case}. 
    \end{minipage}%
    }
    \RenewDocumentCommand{\labelenumi}{}{\fcolorbox{magenta}{white}{\textbf{\arabic{enumi}}}}
