...
\begin{enumerate}
    ...
    \begin{minipage}{.76\textwidth}
        \vspace{0pt}
        \textbf{Nerd Interjection!} If you look at the graph, you'll no doubt notice that this transformation is a reflection. How can we quickly tell if a matrix transform is a reflection 
        and not just a rotation? Visually, we can check if the standard basis vectors have ``swapped'', as in Figure 8. We can also check the matrix itself. If either the top left corner
        or bottom right corner is zero, then it's a reflection. 
    \end{minipage}%
    }
    \begin{figure}[p]
        \centering
    ...
    \begin{figure}[p]
        ...
        \begin{tikzpicture}
            ...
            \node[font={\Huge\bfseries},rotate=315] at (0,2) {\reflectbox{box}}; 
