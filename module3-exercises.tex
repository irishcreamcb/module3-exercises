    ...
    \item \(T(x,y) = (x,-y)\)\begin{solution}
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture} 
                ...
                \draw[black!60,latex-latex] (-1.25,0) -- (2,0) node[below left,font={\small}] {1} -- (3.25,0) node[above right] {\(x\)};
                \draw[black!60,latex-latex] (0,-1.25) -- (0,0) node[below left,font={\small}] {O} -- (0,2) node[below left,font={\small}] {1} -- (0,3.25) node[above left] {\(y\)};
            ...
            \begin{tikzpicture}
                ...
                \draw[black!60,latex-latex] (-1.25,0) -- (2,0) node[below left,font={\small}] {1} -- (3.25,0) node[above right] {\(x\)};
                \draw[black!60,latex-latex] (0,-3.25) -- (0,0) node[below left,font={\small}] {O} -- (0,-2) node[below left,font={\small}] {-1} --  (0,1.25) node[above left] {\(y\)};
    ...
    \item \(T(x,y) = (-x,y)\)\begin{solution}
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}
                ...
                \draw[black!60,latex-latex] (-3.25,0) -- (-2,0) node[below right,font={\small}] {-1} -- (1.25,0) node[above right] {\(x\)};
                \draw[black!60,latex-latex] (0,-1.25) -- (0,0) node[below right,font={\small}] {O} -- (0,2) node[below right,font={\small}] {1} (0,3.25) node[above left] {\(y\)};
    ...
    \item \(T(x,y) = (x,x+y)\)\begin{solution} 
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}
                ...
                \draw[black!60,latex-latex] (-1.25,0) -- (2,0) node[below left,font={\small}] {1} -- (3.25,0) node[above right] {\(x\)};
                \draw[black!60,latex-latex] (0,-1.25) -- (0,0) node[below left,font={\small}] {O} -- (0,2) node[below left,font={\small}] {1} -- (0,4) node[below left,font={\small}] {2} --(0,5.25) node[above left] {\(y\)};
    ...
    \item \(T(x,y) = (x+y,y)\)\begin{solution} 
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}
                ...
                \draw[black!60,latex-latex] (-1.25,0) -- (0,0) node[below left,font={\small}] {O} -- (2,0) node[below left,font={\small}] {1} --(4,0) node[below left,font={\small}] {2} --  (5.25,0) node[above right] {\(x\)};
                \draw[black!60,latex-latex] (0,-1.25) -- (0,2) node[below left,font={\small}] {1} -- (0,3.25) node[above left] {\(y\)};
                \draw[black!90,very thick,-stealth] (0,0) -- (2,0) node[below right] {\(T(\mathbf{e}_1)\)};
    ...
    \item \(T(x,y) = (-2x,3y)\)\begin{solution} 
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}
                ...
                \draw[black!60,latex-latex] (-5.25,0) --(-4,0) node[below right,font={\small}] {-2}--(-2,0) node[below right,font={\small}] {-1}--(0,0) node[below right,font={\small}] {O} -- (1.25,0) node[above right] {\(x\)};
                \draw[black!60,latex-latex] (0,-1.25) --(0,2) node[below right,font={\small}] {1}--(0,4) node[below right,font={\small}] {2}--(0,6) node[below right,font={\small}] {3}-- (0,7.25) node[above left] {\(y\)};
    ...
    \item \(T(x,y) = (x,0)\)\begin{solution} 
        ...
        \begin{figure}[h]
            ...
            \begin{tikzpicture}
                ...
                \draw[black!60,latex-latex] (-1.25,0) -- (0,0) node[below left,font={\small}] {O} -- (3.25,0) node[above right] {\(x\)};
...
\begin{center}
    ...
    \begin{minipage}[c]{0.9\textwidth}
        \centering
        Determine if the following sets of vectors span \(\mathbb{R}^2\). If the set does not, give an example of a vector which cannot be expressed as a linear combination of vectors in \(S\). 
    \end{minipage}
    }
\end{center}
\begin{enumerate}
